...
class GameResultModel : public IActorModel, public ITextModel
{
public:
	GameResultModel() = default;
	virtual ~GameResultModel() = default;

	DISALLOW_COPY_AND_ASSIGN(GameResultModel);
